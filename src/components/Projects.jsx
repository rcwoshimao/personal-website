...
const Projects = () => {
    return(
        ...
        <div className='projects'>
            ...
            <ProjectElement image={RSDB} name={"Sentiment GDP analysis"} shortDescription="Cogs 108 final project. Analysis on how consumer sentiment evolved in response to economic shifts." link={"https://github.com/rcwoshimao/sentiment-gdp-analysis"} /> 
