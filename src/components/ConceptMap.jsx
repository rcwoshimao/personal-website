    ...
    >
      {(zoom) => (
        <div className="relative" style={{ position: 'relative', width: '100%', height: '100%' }}>
          ...
          >
            <rect width={windowSize.width} height={windowSize.height} fill={bg} />
            ...
            {showMiniMap && (
              <g
                ...
                transform={`scale(0.25) translate(${windowSize.width * 4 - windowSize.width - 60}, ${windowSize.height * 4 - windowSize.height - 60})`}
              >
